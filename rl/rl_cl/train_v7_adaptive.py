"""
v7 Training - ADAPTIVE REWARD SCALING
======================================
...
Usage: python train_v7_adaptive.py
"""
...
def train_v7_adaptive():
    """Train with magnitude-adaptive reward scaling"""

    print("="*70)
    print("  v7 TRAINING - ADAPTIVE REWARD SCALING")
    print("="*70)
    print("\n📊 Dataset Strategy:")
    ...
    # Create directory
    os.makedirs("models/rl_v7_adaptive", exist_ok=True)
    ...
    for stage_idx, stage in enumerate(stages):
        ...
        # Save
        save_path = f"models/rl_v7_adaptive/stage{stage_num}_{force_limit//1000}kN.zip"
    ...
    final_path = "models/rl_v7_adaptive/final_v7_adaptive.zip"
    ...
    print(f"\n   This model uses ADAPTIVE reward scaling:")
    ...
    print("="*70)
    print("  COMPARISON: v7 vs v6 vs v5")
    print("="*70)
    ...
    for r in results:
        ...
        print(f"      v7 (adaptive):    {v7_peak:.2f} cm  ← {r['improvement']:+.1f}%\n")
...
if __name__ == "__main__":
    print("\n🚀 Starting v7 ADAPTIVE Training...\n")
    model = train_v7_adaptive()
    if model is not None:
        print("\n✅ Training complete! Adaptive reward scaling model ready.")
    else:
